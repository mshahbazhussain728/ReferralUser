...
>
            ...
            {/* Column 2: Installed Date */}
            <span className="text-base font-medium flex items-center justify-center whitespace-nowrap ml-[-10px]">
              {item?.installedDate ? formatDate(item.installedDate) : "N/A"}
            </span>
            ...
            {/* Column 5: Plan Type */}
            <span className="text-base font-medium flex items-center justify-center capitalize ml-[-20px]">
              {planType}
            </span>
